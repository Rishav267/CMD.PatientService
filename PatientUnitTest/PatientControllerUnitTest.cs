...
namespace PatientUnitTest
{
    ...
    public class PatientControllerUnitTest
    {
        ...
        [TestMethod]
        public void GetPatient_ShouldMatchPatientBloodGroup()
        {
            var patient = GetPatientDetails() as List<PatientAPIModel>;
            var controller = new PatientController();
            var tempPatient = controller.GetPatientById(1) as PatientAPIModel;
        ...
        [TestMethod]
        public async Task GetPatientAsync_ShouldMatchPatientBloodGroup()
        {
            var patient = GetPatientDetails() as List<PatientAPIModel>;
            var controller = new PatientController();
            var tempPatient = await controller.GetPatientByIdAsync(1) as PatientAPIModel;
        ...
        [TestMethod]
        public async Task GetPatientAsync_ShouldMatchPatientLocation()
        {
            var patient = GetPatientDetails() as List<PatientAPIModel>;
            var controller = new PatientController();
            var tempPatient = await controller.GetPatientByIdAsync(1) as PatientAPIModel;
        ...
        [TestMethod]
        public void GetSymptom_ShouldMatchName()
        {
            var symptoms = GetSymptom(); //as List<SymptomAPIModel>;
            var controller = new PatientController();
            var tempSymptom = controller.GetSymptomById(2) as SymptomAPIModel;

            Assert.AreEqual(symptoms.ElementAt(5).Name, tempSymptom.Name);
        }
        ...
        public IEnumerable<SymptomAPIModel> GetSymptom()
        {
